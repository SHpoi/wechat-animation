        ...
        request(options)
          .then(function(response) {
            ...
            if (_data) {
              ...
              throw new Error('batchFetchUser fails');
            }
          })
          .catch(function(err) {
            reject(err);
      ...
      .then(function(data) {
        ...
        request({
            ...
            if (_data) {
              ...
              throw new Error('del mass fails')
            }
          })
          .catch(function(err) {
            reject(err)
...
Wechat.prototype.showQrcode = function(ticket) {
  return api.qrcode.show + 'ticket=' + encodeURI(ticket); //其中的某些字符将被十六进制的转义序列进行替换
}
